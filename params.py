...
def create_parser():
    ...
    if args.create_basic_info:
        data = dict(zip(["epochs", "batch_size", "save_loc", "thresh"],[args.epochs, args.batch_size, args.save_loc, args.thresh]))
        create_json(data=data)

    return args.epochs, args.batch_size, args.save_loc, args.thresh
